...
* 🌐 **Muffin Maker (`muffin-make`):** Quickly scrape and package any online web application or utility into an offline portable desktop app.
...
### 1. Build an App from a Website (`muffin-make`)

You can turn any live website into an offline desktop application using the `muffin-make` utility. This utility downloads the page structure, grabs the favicon, converts it into a standard `.png` desktop icon, and adds it directly to your launcher library.

```
# Usage: muffin-make <URL> [custom-app-name]
muffin-make https://rawg.io rawg-games
...
# Run a local .mpa file from anywhere
